...
def generate_random_traffic(min_bw, max_bw, interval):
    try:
        while True:
...
if __name__ == "__main__":
    ...
    generate_random_traffic(min_bw=args.min_bw, max_bw=args.max_bw, interval=args.interval)
